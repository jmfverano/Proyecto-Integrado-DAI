...
insert into productos  (nombre_prod, descripcion, fabricante, precio, id_categoria, id_proveedor, id_tipo_producto) 
values ('Squier Tele Pick', 'Pastilla del pastil tipo Telecaster con sonido vitage', 'Squier',50.99, 1, 1,2);
